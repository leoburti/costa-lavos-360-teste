...
export default function RelatoriVendasAnual() {
  ...
  const kpis = useMemo(() => {
    ...
    return [
      { label: 'Total de Vendas', value: `R$ ${totalSales.toLocaleString('pt-BR')}`, change: 15.3 },
      { label: 'Total de Pedidos', value: totalOrders, change: 10.2 },
      { label: 'Anos com Venda', value: data.length, change: 0 },
      { label: 'Crescimento', value: '+25%', change: 25 },
    ];
  }, [data]);
  ...
  const columns = [
    ...
    { key: 'growth_rate', label: 'Crescimento', format: (v) => `${v}%`, align: 'right' },
  ];
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <RelatoriChart type="bar" data={data} dataKey="total_sales" xAxisKey="year" />

...
export default function EquipamentosCustos() {
  ...
  const { data: costsData, loading, error, retry } = useAnalyticalData(
    'get_equipment_costs',
    params,
    {
      onError: (err) => {
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold tracking-tight">Análise de Custos</h1>
      ...
      <Card>
        <CardContent className="p-6 space-y-6">
          ...
          {!costsData || costsData.length === 0 ? (
            <EmptyState description="Sem dados de custos para o período." />
          ) : (

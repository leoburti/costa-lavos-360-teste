...
import { Gift, ListPlus, FileSearch, BarChart2, Loader2 } from 'lucide-react';
...
const BonificacoesNovo = () => {
  ...
  const canAnalyze = ['Nivel 1', 'Nivel 2', 'Nivel 3', 'Supervisor'].includes(userContext.role);
...
export default BonificacoesNovo;
...
/**
 * PÁGINA: Analítico de Grupos de Clientes (Restaurada)
 * 
 * Esta página utiliza o componente DrilldownExplorer para oferecer uma visão
 * hierárquica focada nos grupos econômicos (redes) de clientes:
 * Grupo -> Cliente -> Produto
 * 
 * Layout:
      ...
      <div className="grid gap-6">
        <Card className="border-slate-200 shadow-sm bg-white">
          ...
          <CardContent className="p-0 sm:p-6">
            {/* 
              O DrilldownExplorer no modo 'customerGroup' configura a hierarquia:
              Nível 1: Grupos de Clientes (Redes)
              Nível 2: Clientes do Grupo
              Nível 3: Produtos
            */}
            <DrilldownExplorer 
...
export default AnalyticsCustomerGroup;